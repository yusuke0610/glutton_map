...
func (m *memRepo) CountUniqueFansByPrefecture(ctx context.Context, prefecture pin.Prefecture) (int, error) {
	return 0, nil
}
...
func (f *failRepo) Ping(ctx context.Context) error                         { return nil }
func (f *failRepo) CountUniqueFansByPrefecture(ctx context.Context, prefecture pin.Prefecture) (int, error) {
	return 0, nil
}
